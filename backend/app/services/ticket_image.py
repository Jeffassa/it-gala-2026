...
_PRICE_NUMBER_SIZE = 73  # Poppins Medium Italic — chiffres du prix (40px CSS)
_PRICE_F_SIZE = 70       # Poppins Medium Italic — "F" majuscule    (38px CSS)
_PRICE_CFA_SIZE = 64     # Poppins Medium Italic — "cfa" minuscules (35px CSS)
