      ...
      <section id="archive" className="py-28">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <FadeIn className="flex gap-3 justify-center flex-wrap">
            ...
            <a href= "https://www.instagram.com/esaticstudents/" target="_blank" rel="noreferrer" className="btn btn-ghost">
        ...
        <div className="max-w-7xl mx-auto px-6 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-ink-muted">
              ...
              <li><a href= "https://www.instagram.com/esaticstudents/" target="_blank" rel="noreferrer" className="hover:text-accent transition inline-flex items-center gap-1.5">Page Instagram <ArrowUpRight size={12} /></a></li>
            </ul>
          </div>
        </div>
